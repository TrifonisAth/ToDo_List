...
module.exports = __webpack_require__.p + "06b6317a7d1fd28ff160.js";
...
/* harmony import */ var date_fns_parseISO__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! date-fns/parseISO */ "./node_modules/date-fns/esm/parseISO/index.js");
...
function taskLoaderProject(taskList, arg) {
  for (let i = 0; i < taskList.length; i++) {
    ...
    if (arg) {
      ...
      if (arg === "today" && !(0,date_fns_isToday__WEBPACK_IMPORTED_MODULE_7__["default"])((0,date_fns_parseISO__WEBPACK_IMPORTED_MODULE_8__["default"])(task.taskDate))) continue;
      if (
        arg === "week" &&
        !(0,date_fns_isThisWeek__WEBPACK_IMPORTED_MODULE_9__["default"])((0,date_fns_parseISO__WEBPACK_IMPORTED_MODULE_8__["default"])(task.taskDate), { weekStartsOn: 1 }) // Week set to start Monday/
      )
        continue;
...
function clickImportant(ev) {
  ev.target.src = ev.target.src === _star_png__WEBPACK_IMPORTED_MODULE_4__ ? _important_png__WEBPACK_IMPORTED_MODULE_5__ : _star_png__WEBPACK_IMPORTED_MODULE_4__;
